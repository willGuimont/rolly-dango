...
>>>>>>> 5a44afe4f23270607df5d23d442ef73c514f0719
...
proc buildWorld() =
  reg = newRegistry()
<<<<<<< HEAD
  let level = newLevelList(addr reg, addr theGamepad, @[unsafeAddr level05,
      unsafeAddr level04, unsafeAddr level01, unsafeAddr level02,
          unsafeAddr level03])
=======
